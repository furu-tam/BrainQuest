    ...
    <div className="page-wrap">
      <AppShell showNav={false}>
        <main className="flex flex-1 flex-col items-center justify-center px-4 py-8 text-center">
          ...
          <h1 className="mb-2 text-2xl font-extrabold text-mq-primary">Hoàn thành đề hôm nay!</h1>
          <p className="mb-6 text-mq-muted">Con đã làm xong 10 câu ôn luyện Toán.</p>
          {bonus && (
